...
//            ->open('clothes/')
            ...
            ->space(TRUE)
            ->label('19. 上述用户评论显示该商家提供的产品是顾客想要的。')
            ->br()
            ...
            ->space(TRUE)
            ->label('23. 我对商家对于评论者的损失所采取的补偿方式并不满意。')
            ->br()
            ...
            ->space(TRUE)
            ->label('26. 上述用户评论显示该商家提供的产品是做工精细的。')
            ->br()
            ...
            ->space(TRUE)
            ->label('36. 网页中的评论显示该商家提供了与其承诺相一致的产品/服务。')
            ->br()
